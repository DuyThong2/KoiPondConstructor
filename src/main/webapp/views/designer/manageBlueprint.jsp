                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="/uploads/${blueprint.imgUrl}" class="btn btn-primary" target="_blank">View Full Image</a>
                        ...
                        <c:forEach var="blueprint" items="${feedbackBlueprints}">
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm blueprint-card">
                                    <img class="card-img-top rounded" src="/uploads/${blueprint.imgUrl}" alt="Blueprint Image" style="height: 250px; object-fit: cover;">
                                    <div class="card-body">
