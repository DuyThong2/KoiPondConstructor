                    ...
                    <div class="side-bar">
                        <div class="user-info text-center">
                            <img class="img-profile img-circle img-responsive center-block"
                                 src="${user.imgURL != null ? user.getShowingImg(user.imgURL) : "/assets/imgs/logo/final_resized_colored_logo_image.png"}" alt="User Avatar" width="150" />
                            <h4>${user.name}</h4>
                        ...
                        <fieldset class="fieldset">
                            ...
                            <form class="form-horizontal" action="${pageContext.request.contextPath}/imageStaff/uploads" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group avatar">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img class="img-rounded img-responsive" src="${user.imgURL != null ? user.getShowingImg(user.imgURL) : "/assets/imgs/logo/final_resized_colored_logo_image.png"}"
                                                 alt="Avatar" width="80">
                                        </div>
                                        <div class="col-md-10">
