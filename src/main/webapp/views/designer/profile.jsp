            ...
            <div class="side-bar">
                <div class="user-info text-center">
                    <img class="img-profile img-circle img-responsive center-block"
                         src="${user.imgURL != null ? user.getShowingImg(user.imgURL) : "/SWPKoiContructor/assets/imgs/logo/final_resized_colored_logo_image.png"}"
        ...
        <div class="col-md-9">
            <div class="content-panel">
                <fieldset class="fieldset">
                    ...
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/imageStaff/uploads" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group avatar">
                            <div class="row">
                                <div class="col-md-2">
                                    <img class="img-rounded img-responsive" src="${user.imgURL != null ? user.getShowingImg(user.imgURL) : "/SWPKoiContructor/assets/imgs/logo/final_resized_colored_logo_image.png"}"
                                         alt="Avatar" width="80">
                                </div>
                                <div class="col-md-10">
                ...
                <fieldset class="fieldset">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Total Designs In Process:</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" value="${totalDesignInProcess}" readonly />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Total Designs Completed:</label>
                        <div class="col-md-10">
