        ...
        <div class="container">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 mt-4">
                    ...
                    <form:form modelAttribute="term" action="${pageContext.request.contextPath}/manager/updateTerm" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input type="number" path="percentOnDesign1" value="${term.percentOnDesign1}" class="form-control" id="percent_on_design1" min="0" max="100" step="0.01" />
                                    <form:errors path="percentOnDesign1" cssClass="text-danger" />
                                </div>
                                <div class="form-group">
                                    <label for="percent_on_design2">Percent on Design 2</label>
                                    <form:input type="number" path="percentOnDesign2" value="${term.percentOnDesign2}" class="form-control" id="percent_on_design2" min="0" max="100" step="0.01" />
                                    <form:errors path="percentOnDesign2" cssClass="text-danger" />
                                </div>
                                <div class="form-group">
                                    <label for="percent_on_design3">Percent on Design 3</label>
                                    <form:input type="number" path="percentOnDesign3" value="${term.percentOnDesign3}" class="form-control" id="percent_on_design3" min="0" max="100" step="0.01" />
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input type="number" path="percentOnConstruct1" value="${term.percentOnConstruct1}" class="form-control" id="percent_on_construct1" min="0" max="100" step="0.01" />
                                ...
                                <div class="form-group">
                                    ...
                                    <form:input type="number" path="percentOnConstruct2" value="${term.percentOnConstruct2}" class="form-control" id="percent_on_construct2" min="0" max="100" step="0.01" />
