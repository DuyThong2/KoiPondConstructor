<%-- Document : projectManage Created on : Sep 21, 2024, 2:33:13 PM Author : ASUS --%>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:forEach var="stage" items="${project.design.designStage}">
                                                                    <c:if test="${stage.designStageId > maxDesignStageId}">
                                                                        <c:set var="maxDesignStageId" value="${stage.designStageId}" />
                                                                        <c:set var="latestDesignStageName" value="${stage.designStageName}" />
                                                                    </c:if>
                                                                </c:forEach>
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <span class="badge badge-info">${latestDesignStageName}</span>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                            <td colspan="4">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${project.construction.constructionStatus == 4}">
                                                                        <span
                                                                            class="badge badge-warning">Cancelled</span>
                                                                    </c:when>
                                                                </c:choose>
                                                            ...
                                                            <td>
                                                                ...
                                                                <c:forEach var="stage" items="${project.construction.constructionStage}">
                                                                    <c:if test="${stage.constructionStageId > maxConstructionStageId}">
                                                                        <c:set var="maxConstructionStageId" value="${stage.constructionStageId}" />
                                                                        <c:set var="latestConstructionStageName" value="${stage.constructionStageName}" />
                                                                    </c:if>
                                                                </c:forEach>
                                                                <c:choose>
                                                                    <c:when test="${latestConstructionStageName == 'N/A'}">
                                                                        <span class="badge badge-light">Not Yet</span>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <span class="badge badge-info">${latestConstructionStageName}</span>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                            <td colspan="4">
