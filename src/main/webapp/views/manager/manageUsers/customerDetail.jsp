                ...
                <div class="row">
                    ...
                    <%@include file="../navBar.jsp" %>
                        ...
                        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                            ...
                            <!-- Projects Section -->
                            <div class="section-card">
                                <h4 class="section-header"><i class="fas fa-project-diagram"></i> Associated Projects
                                </h4>
                                        ...
                                        <tbody>
                                            <c:forEach var="project" items="${projects}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="${pageContext.request.contextPath}/manager/projects/detail/${project.projectId}"
                            ...
                            <!-- Service Section -->
                            <div class="section-card">
                                <h4 class="section-header"><i class="fas fa-project-diagram"></i> Associated Service
                                </h4>
                                        ...
                                        <tbody>
                                            <c:forEach var="detail" items="${serviceDetails}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${detail.serviceDetailStatus == 1}">
                                                                <span id="badge-${service.id}"
                                                                    class="badge badge-secondary">Pending</span>
                                                            </c:when>
                                                            <c:when test="${detail.serviceDetailStatus == 2}">
                                                                <span id="badge-${service.id}"
                                                                    class="badge badge-primary">Processing</span>
                                                            </c:when>
                                                            <c:when test="${detail.serviceDetailStatus == 3}">
                                                                <span id="badge-${service.id}"
                                                                    class="badge badge-success">Completed</span>
                                                            </c:when>
                                                            <c:when test="${detail.serviceDetailStatus == 4}">
                                                                <span id="badge-${service.id}"
                                                                    class="badge badge-warning">Requesting Cancel</span>
                                                            </c:when>
                                                            <c:when test="${detail.serviceDetailStatus == 5}">
                                                                <span id="badge-${service.id}"
                                                    ...
                                                    <td>
                                                        <form
                                                            action="${pageContext.request.contextPath}/manager/serviceDetail/detail/${detail.id}"
                                                            method="GET" class="d-inline">
                                                            <button type="submit" class="btn btn-info">
                                                                <i class="fas fa-eye icon-btn"></i> Details
                                                            </button>
