            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 mt-4">
                    ...
                    <div class="filter-card">
                        <!-- Search Form -->
                        <form action="${pageContext.request.contextPath}/manager/manageStaff" method="GET"
                            ...
                            <div class="col-md-2 mb-3">
                                <select name="department" class="form-control">
                                    ...
                                    <option value="Construction" ${param.department=="Construction" ? 'selected'
                                                                   : '' }>Construction</option>
                                    <option value="Consulting" ${param.department=="Consulting" ? 'selected'
                                                                 : '' }>Consultant</option>
                                    <option value="Design" ${param.department=="Design" ? 'selected' : '' }>
                                        Designer</option>
                                    <option value="Management" ${param.department=="Management" ? 'selected'
                                                                 : '' }>Manager</option>
                                </select>
                            </div>
                            <!-- Status Dropdown -->
                            ...
                            <div class="col-md-2 mb-3" style="text-wrap:nowrap;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                ...
                                                <c:when test="${!staffs.enabled}">
                                                    <span class="badge badge-warning badge-status">Inactive</span>
                                                </c:when>
                                            </c:choose>
                                        </td>
                                        <td>
                                            <c:if test="${staffs.department != 'Management'}">
                                                <a href="${pageContext.request.contextPath}/manager/manageStaff/detail/${staffs.id}"
                                                   class="btn btn-info btn-block">
                                                    Detail</a>
                                                <form
                                                    action="${pageContext.request.contextPath}/manager/manageUser/block/${staffs.id}"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <c:if test="${currentPage > 0}">
                            <a href="?page=${currentPage - 1}&name=${param.name}&searchEmail=${param.searchEmail}&department=${param.department}&status=${param.status}" 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addStaffForm" action="${pageContext.request.contextPath}/manager/manageStaff/add"
                              method="POST" onsubmit="return validateEmail() && validatePasswords()">
