                    ...
                    <div class="row info-section">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="info-box">
                                ...
                                <c:if
                                    test="${serviceDetail.serviceDetailStatus!=5 && serviceDetail.serviceDetailStatus!=3}">
                                    <p class="w-100 text-center">
                                        <button class="btn btn-danger btn-cancel-service">
                                            cancel
                                        </button>
                                    </p>
                                </c:if>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="info-box">
                                ...
                                <div class="row hover-row w-100 d-flex justify-content-center">
                ...
                <div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="${pageContext.request.contextPath}/manager/serviceDetails/updateStatus" method="POST">
                            <div class="modal-footer">
                                <input type="hidden" name="serviceDetailId" value="${serviceDetail.id}">
