                                            ...
                                            <tbody>
                                                <c:if test="${service.content != null}">
                                                    <tr>
                                                        ...
                                                        <td> <fmt:formatDate value="${service.content.createDate}" pattern="MMM dd yyyy" /></td>
                                                        <td> <fmt:formatDate value="${service.content.lastUpdatedDate}" pattern="MMM dd yyyy" /></td>
                                                        <td>
                                                            <c:if
