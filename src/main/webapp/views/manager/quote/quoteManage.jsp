                                ...
                                5.refused(customer), 6.refused(by staff), 7. cancel -->
                                                    <c:choose>
                                                        <c:when test="${quote.quotesStatus == 1}">
                                                            <span
                                                                class="badge badge-warning badge-status">Pending</span>
                                                        </c:when>
                                                        <c:when test="${quote.quotesStatus == 2}">
                                                            <span
                                                                class="badge badge-secondary badge-status">Approved</span>
                                                        </c:when>
                                                        <c:when test="${quote.quotesStatus == 3}">
                                                            <span
                                                                class="badge badge-danger badge-status">Rejected</span>
                                                        </c:when>
                                                        <c:when test="${quote.quotesStatus == 4}">
                                                            <span class="badge badge-success badge-status">Accepted By
                                                                Customer</span>
                                                        </c:when>
                                                        <c:when test="${quote.quotesStatus == 5}">
                                                            <span class="badge badge-success badge-status">Refused By
                                                                Customer</span>
                                                        </c:when>
                                                        <c:when test="${quote.quotesStatus == 6}">
                                                            <span class="badge badge-success badge-status">Refuse By
                                                                Staff</span>
                                                        </c:when>
