...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <form:form action="${pageContext.request.contextPath}/consultant/quote/saveNewQuotes" modelAttribute="newQuote" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="true">
