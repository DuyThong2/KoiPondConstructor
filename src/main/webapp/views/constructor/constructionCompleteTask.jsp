        ...
        <c:forEach var="detail" items="${details}">
            <form action="${pageContext.request.contextPath}/constructionStageDetail/updateStatus" method="post" onsubmit="return confirmStatusChange();">
                ...
                <tr>
                    ...
                    <td>
                        <!-- Display status label if it's a payment stage or the stage is already completed/canceled -->
                        <c:choose>
                            <c:when test="${detail.constructionStageDetailName == 'Payment' || detail.constructionStageDetailStatus == 4 || !canUpdateNext}">
                    ...
                    <td>
                        <!-- Hide button for Payment stage or if previous stage is incomplete -->
                        <c:if test="${canUpdateNext && detail.constructionStageDetailName != 'Payment' && detail.constructionStageDetailStatus != 4}">
