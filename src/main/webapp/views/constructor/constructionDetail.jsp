        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="left-column">
                    <div class="img-box">
                        <img src="${construction.project.getShowingImg(construction.project.imgURL)}" alt="Construction Project Image" style="width: 431px;">
                    </div>
                                ...
                                <div class="feedback-item">
                                    <div class="comment">
                                        <div id="comment-content-${comment.commentId}">
                                            ...
                                            <p class="text-muted small" style="font-size: 17px"><fmt:formatDate value="${comment.datePost.time}" pattern="MMM dd yyyy HH:mm"/></p>
