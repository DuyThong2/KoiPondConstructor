            ...
            <div class="row">
                ...
                <div class="right-column">
                    ...
                    <div class="stage-tabs" id="stage-buttons">
                        <button class="btn btn-outline-primary" data-stage="Raw Construction" data-status="0">Raw Construction</button>
                        <button class="btn btn-outline-primary" data-stage="Complete Construction" data-status="0">Complete Construction</button>
                    </div>
                    ...
                    <c:forEach var="stage" items="${constructionStages}">
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <h4><a href="${pageContext.request.contextPath}/constructor/manage/constructionStage/${stage.constructionStageId}">${stage.constructionStageName}</a></h4>
                                <p>
                                    <c:choose>
