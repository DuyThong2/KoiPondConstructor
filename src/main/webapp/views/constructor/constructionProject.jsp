...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <header>
                <div class="nav">
                    <a href="/constructor/manage" class="nav-link">My Constructions</a>
            ...
            <div class="info-section">
                ...
                <div class="info-box">
                    <h4>Construction Information</h4>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        <p><strong>End Date:</strong>
                            <c:choose>
                                ...
                                <c:otherwise>${construction.project.dateEnd}</c:otherwise>
                            </c:choose>
                        </p>
                    </div>
                    <div class="info-item">
                        <p><strong>Construction Status:</strong>
                            <c:choose>
                                <c:when test="${construction.constructionStatus == 1}">Pending</c:when>
                                <c:when test="${construction.constructionStatus == 2}">Processing</c:when>
                                <c:when test="${construction.constructionStatus == 3}">Completed</c:when>
                                <c:when test="${construction.constructionStatus == 4}">Canceled</c:when>
                            </c:choose>
                        </p>
                    </div>
                </div>
