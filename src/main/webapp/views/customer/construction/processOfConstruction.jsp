    ...
    <head>
        ...
        <script>
            function createPayPalButton(detailId, constructionStageId, constructionId, amount, targetId) {
                ...
                form.action = '${pageContext.request.contextPath}/paypal/pay/construction';
                form.method = 'post';
            ...
            function createApproveRejectButtons(detailId, constructionStageId, constructionId, targetId) {
                ...
                approveForm.action = '${pageContext.request.contextPath}/customer/approveInspection';
                ...
                approveButton.addEventListener('click', function (event) {
                    if (!confirm("Are you sure to complete this phase?")) {
                        event.preventDefault(); // Ngăn chặn hành động submit nếu không xác nhận
                    }
                });
                const rejectForm = document.createElement('form');
                rejectForm.action = '${pageContext.request.contextPath}/customer/rejectInspection';
