                ...
                <%@include file="../homePageNavbar.jsp" %>
                                ...
                                <div class="col-md-6">
                                    <div class="section__title-wrapper text-center text-xl-start">
                                        <span class="section__subtitle justify-content-start mb-13"><span
                                            ...
                                            </span> <a href="${pageContext.request.contextPath}/home/services"
                                                class="theme-color">Home - Service</a></span>
                                ...
                                <div class="single-portfolio-wrap">
                                    ...
                                    <div class="col-lg-4">
                                        <div
                                            ...
                                            <h4 class="heading-title">Service Information:</h4>
                                            ...
                                            <div class="project-details__author-body">
                                                <div class="project-details__author-item__wrapper">
                                                    <div class="project-details__author-item d-flex flex-column">
                                                        <span class="sub-t">Service Name:</span>
                                                        <span class="title">${service.serviceName}</span>
                                                    </div>

                                                    <div class="project-details__author-item d-flex flex-column">
                                                        <span class="sub-t">Price:</span>
                                                        <span class="title">&dollar;${service.servicePrice[0].value} per square meter</span>
                                                    </div>
                                                    <div class="project-details__author-item d-flex flex-column">
                                                        <span class="sub-t">Description:</span>
                                                        <span class="title">${service.serviceDescription}</span>
                                                    </div>
                                                    <div class="project-details__author-item d-flex flex-column">
                                                        <span class="sub-t">Rating:</span>
                                                        <c:if test="${empty avgRating}">
                                                            <div class="title"> No Rating Yet</div>
                                                        </c:if>
                                                        <c:if test="${not empty avgRating}">
                                                            <div class="title rating-number"></div>
                                                            <span class="title">
                                                                <%-- Assume service.rating is a decimal number, e.g.,
                                                                    4.5 --%>
                                                                    <c:set var="rating" value="${avgRating}" />

                                                                    <%-- Extract integer part as a string using
                                                                        substringBefore --%>
                                                                        <c:set var="fullStars"
                                                                            value="${fn:substringBefore(rating, '.')}" />

                                                                        <%-- Determine if there should be a half star
                                                                            --%>
                                                                            <c:set var="halfStar"
                                                                                value="${(rating - fullStars) > 0 ? 1 : 0}" />

                                                                            <%-- Calculate empty stars to make up to 5
                                                                                stars --%>
                                        ...
                                        <div
                                        class="project-details__author project-details__author__up position-relative z-3 mt-3">
                                        <h4 class="heading-title" style="background-color: rgb(48, 48, 48);">Customer Feedback:</h4>

                                        <div class="project-details__author-body">
                                            <c:if test="${empty serviceDetailList}">
                                                     <div class="title"> No Feedback Yet</div>
                                            </c:if>
                                           <c:forEach var="feedback" items="${serviceDetailList}">
                                            <div class="project-details__author-item__wrapper mb-3">
                                                <div class="project-details__author-item d-flex flex-column">
                                                    <span class="sub-t">Customer: <span class="title">${feedback.customer.name}</span></span>
                                                   
                                                </div>

                                              
                                                <div class="project-details__author-item d-flex flex-column">
                                                    <span class="sub-t">Feedback:    <span class="title">${feedback.feedback}</span></span>
                                                 
                                                </div>
                                                <div class="project-details__author-item d-flex flex-column">
                                                    <span class="sub-t">Rating:     <span class="title">
                                                        <!-- Set rating to feedback.rating -->
                                                        <c:set var="rating" value="${feedback.rating}" />
                                                
                                                        <!-- Full stars directly from rating -->
                                                        <c:set var="fullStars" value="${rating}" />
                                                
                                                        <!-- No half star needed for whole numbers -->
                                                        <c:set var="halfStar" value="0" />
                                                
                                                        <!-- Calculate empty stars to make up to 5 stars -->
                                        ...
                                        <div
                                            class="project-details__author project-details__author__up position-relative z-3 mt-5">
                                ...
                                <div class="offset-md-2 col-md-8 mt-5">
                                    <div class="section__title-wrapper text-center mb-60 mb-sm-40 mb-xs-35">
                                        <span class="section__subtitle justify-content-center mb-13 ml-0"><span
                                                data-width="40px" class="left-separetor"></span>Template Projects<span
                                                data-width="40px" class="right-separetor"></span></span>
                                        <h2 class="section__title title-animation text-capitalize rr-br-hidden-md"
                                            data-cursor="-opaque">Our Awesome Creative Best
                                            <br> Projects
                                        </h2>
                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="service-box-wrap service-box-style-1 text-center">
                                                    ...
                                                    <div class="service-icon mb-3">
                                                        <img src="${service.serviceImgUrl != null ? service.getShowingImg(service.serviceImgUrl) : "
                                                            /SWPKoiContructor/assets/imgs/logo/zoomed_logo_image.png"}"
                                                    ...
                                                    <div class="section-inner-content">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/home/services/${service.serviceId}"
                                                            class="btn rr-btn">Detail</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </c:forEach>
                    ...
                    <%@include file="../footer.jsp" %>
                        ...
                        <%@include file="../scriptTemplate.jsp" %>
                            <script>
                                var ratingNumber = ${ avgRating };
                                $('.rating-number').text(ratingNumber.toFixed(1));
                            </script>
            </body>
