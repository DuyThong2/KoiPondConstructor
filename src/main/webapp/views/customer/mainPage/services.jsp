                ...
                <%@include file="../cssCustom.jsp" %>
                    ...
                    <style>
                        ...
                        .process-item {
                            ...
                            border-radius: 15px;
                            /* Increased border-radius for softer edges */
                            flex: 0 1 calc(33.333% - 30px);
                            /* Adjust width */
                            box-shadow: 0 6px 15px rgba(0, 0, 0, 0.08);
                            /* Softer shadow for more elegance */
                        ...
                        @media (max-width: 480px) {
                            ...
                            .process-number {
                                font-size: 3em;
                                /* Smaller number font for mobile */
                            }
                                        ...
                                        <div class="col-md-4">
                                            <div class="service-box-wrap service-box-style-1 text-center">
                                                ...
                                                <div class="service-icon mb-3 position-relative">
                                                    <img src="${service.serviceImgUrl != null ? service.getShowingImg(service.serviceImgUrl) : '/SWPKoiContructor/assets/imgs/logo/zoomed_logo_image.png'}"
