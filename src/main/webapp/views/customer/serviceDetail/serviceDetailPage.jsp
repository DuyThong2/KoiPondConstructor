                                            ...
                                            <form method="get" action="/manager/serviceDetails">
                                                <div class="form-row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <select name="sortBy" id="sortBy" class="form-control" size="padding: 20px">
                                                            <option value="serviceDetailStatus"
                                                                    ${sortBy=='serviceDetailStatus' ? 'selected' : ''}>Service Detail Status
                                                            </option>
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <select name="sortType" id="sortType" class="form-control" size="padding: 20px">
                                            ...
                                            <tbody>
                                                <c:forEach var="service" items="${serviceDetailsList}">
                                                    ...
                                                    <tr onclick="toggleDetails(${service.id})">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-default btn-info">Details</button>
                                                        </td>
                                                    </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <button class="btn btn-info"
                                                                                        onclick="window.location.href = '/customer/manageCustomer/detail/${service.customer.id}'">
                                                                                    Customer Details
                                                                                </button>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <c:if test="${empty service.staff}">
                                                                        <tr>
                                                                            <td colspan="5"
                                                                                class="text-center">
                                                                                <a href="/customer/serviceDetails/assign/${service.id}"
