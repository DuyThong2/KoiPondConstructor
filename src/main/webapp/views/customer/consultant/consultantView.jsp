<%-- 
    Document   : consultantView
    Created on : Oct 26, 2024, 4:39:31 PM
    Author     : HP
--%>
                                            ...
                                            <div class="row align-items-center d-flex justify-content-between">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <select name="sortBy" id="sortBy" class="form-control" size="padding: 20px;">
                                                        ...
                                                        <option value="consultantType" ${sortBy == 'consultantType' ? 'selected' : ''}>Type</option>
                                                        <option value="consultantStatus" ${sortBy == 'consultantStatus' ? 'selected' : ''}>Status</option>                                        
                                                    </select>
                                                </div>
